...
public class HomeSteps extends CommonUtility {
	...
	public void userFillNewAddressFormWithBelowInformation(DataTable dataTable) {
		...
		sendText(factory.accountPage().streertInputAddress, addAddress.get(0).get("streetAddress"));
		sendText(factory.accountPage().apartmentInputAddress, addAddress.get(0).get("apt"));
		sendText(factory.accountPage().cityInputAddress, addAddress.get(0).get("city"));
		selectByVisibleText(factory.accountPage().stateDropDownAddress, addAddress.get(0).get("state"));
		sendText(factory.accountPage().zipCodeInputAddress, addAddress.get(0).get("zipCode"));
		slowDown(3000);
